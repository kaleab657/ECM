    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="grid gap-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <a href="mailto:ethiocarsmarket@gmail.com" className="bg-white dark:bg-zinc-900 rounded-[32px] p-6 shadow-sm border border-zinc-100 dark:border-zinc-800 hover:border-brand dark:hover:border-brand transition-colors group">
