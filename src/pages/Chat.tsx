...
export const Chat: React.FC<ChatProps> = ({ initialChatId, onChatChange }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto h-[calc(100dvh-130px)] md:h-[calc(100vh-10rem)] bg-white dark:bg-zinc-900 md:rounded-[40px] shadow-xl shadow-black/5 border border-zinc-100 dark:border-zinc-800 overflow-hidden flex flex-col md:flex-row">
      <ChatSidebar 
        sessions={sessions}
