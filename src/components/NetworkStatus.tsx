...
export const NetworkStatus: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-zinc-900/60 dark:bg-black/60 backdrop-blur-md flex items-center justify-center p-6 animate-in fade-in duration-300">
      <div className="bg-white dark:bg-zinc-950 w-full max-w-[320px] rounded-[32px] p-8 shadow-2xl border border-zinc-100 dark:border-zinc-800 text-center flex flex-col items-center animate-in zoom-in-95 duration-300">
